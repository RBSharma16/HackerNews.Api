...
namespace HackerNews.Test.Controllers
{
    public class HackerNewsControllerFixture
    {
        ...
        public readonly List<int> SampleStoryIds = new List<int>() { 43615912, 43613194, 43592116, 43602522, 43600363, 43615986, 43614199, 43585911, 43614285, 43615322, 43616604, 43617493, 43618140, 43618494, 43577490, 43618105, 43615925, 43612102, 43615346, 43616241 };
        ...
        public HackerNewsControllerFixture()
        {
            ...
            MockHackersNewsApiClient.Setup(hn => hn.GetStoryItemAsync(It.IsAny<int>())).ReturnsAsync(SampleStoryItems?.FirstOrDefault());
            //MockHackersNewsApiClient.Setup(hn => hn.GetStoryItemsAsync()).ReturnsAsync(storyItems);
        }
